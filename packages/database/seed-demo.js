...
async function main() {
  console.log('🌱 Sembrando base de datos Fim con perfiles de prueba para Admin...');
  ...
  console.log('Creando conductor Pedro...');
  ...
  console.log('Creando conductor Luis...');
  ...
  console.log('Creando conductor Carlos...');
  ...
  console.log('Creando conductora Sofia...');
  ...
  console.log('Creando calificaciones para Pedro...');
  ...
  console.log('Creando calificaciones para Luis...');
  const luisTripsData = [
  ...
  console.log('Creando calificaciones para Carlos...');
  ...
  console.log('Creando calificaciones para Sofia...');
  ...
  console.log('🎉 Perfiles de demostración creados con éxito en Supabase!');
}

main()
  .catch((e) => {
    console.error('❌ Error al sembrar perfiles:', e);
    process.exit(1);
  })
  .finally(async () => {
