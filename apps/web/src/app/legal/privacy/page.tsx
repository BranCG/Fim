  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', padding: '40px 24px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--text-muted)', marginBottom: '40px' }}>Última actualización: 26 de Mayo, 2026</p>

        <section style={{ display: 'flex', flexDirection: 'column', gap: '32px', lineHeight: 1.7 }}>
          <div>
            <h2 style={{ color: 'var(--accent)', marginBottom: '12px', fontSize: '1.4rem' }}>1. Datos Personales Recolectados</h2>
          ...
          <div>
            <h2 style={{ color: 'var(--accent)', marginBottom: '12px', fontSize: '1.4rem' }}>2. Almacenamiento de Datos de Transacciones (Fines de Auditoría y SII)</h2>
            <p>
          ...
          <div>
            <h2 style={{ color: 'var(--accent)', marginBottom: '12px', fontSize: '1.4rem' }}>3. Trazabilidad y Gestión de Seguridad (Riesgo de Accidentes)</h2>
            <p style={{ marginBottom: '12px' }}>
          ...
          <div>
            <h2 style={{ color: 'var(--accent)', marginBottom: '12px', fontSize: '1.4rem' }}>4. Colaboración Activa con las Autoridades y la Justicia</h2>
            <p>
          ...
          <div>
            <h2 style={{ color: 'var(--accent)', marginBottom: '12px', fontSize: '1.4rem' }}>5. Seguridad de los Datos</h2>
            <p>
          ...
          <div>
            <h2 style={{ color: 'var(--accent)', marginBottom: '12px', fontSize: '1.4rem' }}>6. Derechos del Usuario y Eliminación de Datos</h2>
            <p>
